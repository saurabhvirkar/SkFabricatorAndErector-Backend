                    ...
                    await context.Database.ExecuteSqlRawAsync(@"
                        ...
                        BEGIN
                            ...
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'Inquiries') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'Inquiries' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""Inquiries"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'Photos') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'Photos' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""Photos"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'Projects') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'Projects' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""Projects"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'OurServices') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'OurServices' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""OurServices"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'TeamMembers') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'TeamMembers' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""TeamMembers"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'Clients') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'Clients' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""Clients"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'ClientDetails') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'ClientDetails' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""ClientDetails"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'HomeSliders') THEN
                                IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'HomeSliders' AND column_name = 'Id' AND is_identity = 'YES') THEN
                                    ALTER TABLE ""HomeSliders"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;
                                END IF;
                            END IF;
                        END $$;
                    ");

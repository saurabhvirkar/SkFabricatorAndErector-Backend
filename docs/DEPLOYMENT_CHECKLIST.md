...
- [x] **CORS Domain Restrictions**: Production `AllowedOrigins` explicitly configured to production domain (`https://skfabricatorui.onrender.com`), eliminating wildcard (`*`) origins.
